  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        disabled={syncing}
        className="flex items-center gap-2 rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-70"
      >
      ...
      {panelOpen && (phase === "success" || phase === "error") && (
        <div className="absolute right-0 z-50 mt-2 w-80 rounded-xl border border-slate-200 bg-white p-4 shadow-lg">
          <button
